...
function popdate(obj, div, tam, ddd) {
	...
	txt += " <a href=javascript:pop_month('" + obj + "','" + div + "','" + tam + "','" + ano + "') class='mes'>" + umonth[mmonth] + "</a> <div id='popd' style='border:none; background-color:transparent; position:absolute'></div></td></tr>";
