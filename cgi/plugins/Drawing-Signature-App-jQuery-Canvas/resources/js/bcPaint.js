	...
	**/
	var isDragged		= false,
		...
		templates 		= {
							...
							buttonReset 	: $('<button id="bcPaint-reset">Apagar</button>'),
							buttonSave		: $('<button id="bcPaint-export">Salvar</button>')
						},
		paintCanvas,
		paintContext;
	...
	$.extend(true, $.fn.bcPaint, {
		...
		*/
		export : function(){
			...
			//windowOpen.document.write('<img src="' + imgData + '" alt="' + idOS.value + '"/>');
			//document.getElementById('bcPaint').innerHTML = '<input type="file" src="' + imgData + '" alt="' + idOS.value + '"/>';
			//console.log(imgData);
			//exportar(idOS, imgData);
